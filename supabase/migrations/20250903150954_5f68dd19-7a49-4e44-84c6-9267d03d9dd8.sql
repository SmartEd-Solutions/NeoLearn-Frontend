...
-- Phase 3: Enhanced Access Control - Create granular policy for parent contact info

-- Create a separate policy for parent contact information access
CREATE POLICY "Only admins and assigned teachers can view parent contact info" 
ON public.students 
FOR SELECT 
TO authenticated
USING (
